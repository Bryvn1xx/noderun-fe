...
const App = () => {
  ...
  const getFeeds = async (req, res) => {
    try {
      const feed = await axios.get('https://noderun-be.herokuapp.com/api/feed')
  ...
  const getWindowsFeed = async (req, res) => {
    try {
      const windowsFeed = await axios.get(`https://noderun-be.herokuapp.com/api/posts/2`)
  ...
  const getPostsByFeed = async (req, res) => {
    try {
      const posts = await axios.get(`https://noderun-be.herokuapp.com/api/posts/1`)
